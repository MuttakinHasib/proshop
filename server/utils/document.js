export const orderTables = (order, req) => {
  ...
  return `
    <div style="max-width: 680px;">
      ...
      }/order/${order._id}" target="_blank">${process.env.CLIENT_URL}/order/${
    order._id
  }</a>
    <br />
      <table
        ...
        <tbody>
          <tr>
            ...
            <td
              ...
              "
            >
              <b>Name:</b> ${order.user.name || req.user.name}<br />
              <b>E-mail:</b>
              <a href="mailto:${
                order.user.email || req.user.email
              }" target="_blank"
                >${order.user.email || req.user.email}</a><br />
              <b>Telephone:</b> ${order?.shippingAddress?.telephone}<br />
              <b>Order Status:</b> ${
                order.isPaid
                  ? order.isDelivered
                    ? 'Delivered'
        ...
        <tbody>
          <tr>
            <td style="
                  ...
                  padding: 7px;
                ">
              ${order.user.name || req.user.name}<br />
      ...
      <table style="border-collapse:collapse;width:100%;border-top:1px solid #dddddd;border-left:1px solid #dddddd;margin-bottom:20px">
        ...
        <tfoot>
          ...
          <tr>
            <td
              style="font-size:12px;border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:right;padding:7px"
              colspan="3"><b>Flat Shipping Rate:</b></td>
              <td
              style="font-size:12px;border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:right;padding:7px">
                $${order?.shippingPrice}
              </td>
